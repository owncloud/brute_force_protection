...
return (new Config())
	->withProfile(
		(new Profile(
			...
			->withSuite(
				(new Suite('webUIBruteForceProtection'))
					->addContext(
					...
					->withPaths('%paths.base%/../features/webUIBruteForceProtection')
			)
			->withSuite(
				(new Suite('apiBruteForceProtection'))
					->addContext(
						'BruteForceProtectionContext',
					)
					->addContext(
					...
					->withPaths('%paths.base%/../features/apiBruteForceProtection')
			)
	);
