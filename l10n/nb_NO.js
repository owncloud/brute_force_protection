OC.L10N.register(
    ...
    "Too many failed login attempts. Try again in %s." : "For mange feilede innloggingsforsøk. Prøv igjen om  %s.",
    "_ %n minute_::_ %n minutes_" : ["%n minutter","%n minutter"],
    "_ %n hour_::_ %n hours_" : ["%n timer","%n timer"],
